...
public class FileUtils {
    ...
    /**
     * Obținerea tuturor  conturilor din DB (accounts.txt)
     * @return List<Account>
    ...
    /**
     * Salvarea contului in BD (accounts.txt)
     * @param listAccounts
     * @throws FileNotFoundException, IOException 
     */
    ...
    /**
     * Citeste toate tranzactiile din BD (transactions.txt)
    ...
    /**
     * Salvarea noii liste a tranzactiilor în DB (transactions.txt)
    ...
    /**
     * Citeste cantitatea totala din lista de tranzactii
     * @param listTransactions
     * @return 
     */
