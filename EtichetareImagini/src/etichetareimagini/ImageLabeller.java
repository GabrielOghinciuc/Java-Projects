...
public class ImageLabeller extends JFrame implements ActionListener {
    ...
    public ImageLabeller(File file) throws IOException {
    	super("Etichetarea Imaginilor Lab stud 231TI 2018");
    ...
    // fereastra se mareste porin indentare cu 50 de pixeli 
    // la fiecare margine a ecranului.        
        int inset = 0;
    ...
    private JMenuBar createMenuBar() {
        ...
        //file menu
        JMenu fmenu = new JMenu("Fisiere");
        fmenu.setMnemonic(KeyEvent.VK_F);
        menuBar.add(fmenu);
        
        //edit menu
        JMenu emenu = new JMenu("Editare");
