...
public class AddEdit extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {                                        
        ...
        if(formMode){
            if(ContactUtil.appendTextContact(buildContact + "\r\n")){
                JOptionPane.showMessageDialog(null,"Successfully add contact : " + Name);               
                ContactUtil.readPhoneContacts(); // re read contact file to reload arrayList
            ...
            if(ContactUtil.updateContact(editContactDetails.getName(),
